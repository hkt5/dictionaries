...
class CreateDictionaryStrategy implements StrategyInterface
{
    ...
    public function run(Request $request = null): JsonResponse
    {
        ...
        try {
            ...
            return $this->createDictionary($request);
        } catch (\Exception $e) {
    ...
    private function createDictionary(Request $request) : JsonResponse
    {
        ...
        if($validator->fails()){
            ...
            return response()->json(
                [
                    'content' => ['dictionary' => DictionaryRepository::getInstance()->create($request)],
                    'error_messages' => [],
                ], Response::HTTP_OK
            );
        }
