...
class ForceDeleteItemStrategyTest extends TestCase
{
    ...
    public function testForceDeleteDictionaryItemWhenDictionaryItemIdFieldIsEmpty() : void
    {

        // given
        $strategy = new ForceDeleteItemStrategy();
        $request = MockingRequest::createRequest(
            [
                'parameters' => [

                ], 'method' => '', 'uri' => '', 'content' => '', 'server' => [], 'files' => [], 'cookies' => [],
            ]
        );
        $response = [
    ...
    public function testForceDeleteDictionaryItemWhenDictionaryItemIdIsNotInteger() : void
    {
    ...
    public function testForceDeleteDictionaryItemWhenDictionaryItemIdNotExisting() : void
    {
    ...
    public function testForceDeleteDictionaryItem() : void
    {
